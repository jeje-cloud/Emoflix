...
const Header = () => {
  ...
  const handleGoogleAuth = () => {
    window.open(
      `https://accounts.google.com/o/oauth2/auth?client_id=751047087683-kd88h5t67glb9c12b2g12svtr9a3a4co.apps.googleusercontent.com&redirect_uri=${window.location.origin}&response_type=token&scope=email%20profile`,
      "_self"
    );
  };
